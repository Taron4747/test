...
@endif
	<div class="panel panel-flat">
							...
							<div class="modal-content">
                                ...
                                @endif
										...
										<div class="form-group">
											...
											<div class="col-sm-9">
												<textarea rows="5" name="proxy_list" id="proxy_list" cols="5" class="form-control" placeholder=""></textarea>
					...
					<button id="openProxyList" style="display: block;" type="text" data-toggle="modal" data-target="#proxyListModal"  class="btn btn-primary"></button>
